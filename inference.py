...
class AutoFetalInference:
    ...
    def run_nnunet_prediction(self):
        ...
        # INJECT THE WEIGHTS PATH INTO THE ENVIRONMENT
    ...
    def _get_expected_volume(self, class_name: str, ga: float) -> float:
        if class_name == "eCSF": return (-340.27 * (ga**2)) + (24558.44 * ga) - 344143.06
        elif class_name == "Cortical_Gray_Matter": return (308.44 * (ga**2)) - (12623.12 * ga) + 140382.44
        elif class_name == "White_Matter": return (10.75 * (ga**2)) + (8679.87 * ga) - 165151.04
        elif class_name == "Ventricles_and_Cavum": return (-21.85 * (ga**2)) + (1470.58 * ga) - 18449.31
        elif class_name == "Cerebellum": return (49.81 * (ga**2)) - (1861.91 * ga) + 18470.62
        elif class_name == "Deep_Gray_Matter": return (20.11 * (ga**2)) - (219.01 * ga) - 876.08
        elif class_name == "Brainstem": return (1.32 * (ga**2)) + (292.04 * ga) - 4883.74
        else: return 0.0

    def _get_class_std(self, class_name: str) -> float:
        std_map = {
            "eCSF": 3821.40, "Cortical_Gray_Matter": 1116.21, "White_Matter": 4224.27,
            "Ventricles_and_Cavum": 193.51, "Cerebellum": 123.78, "Deep_Gray_Matter": 364.52,
            "Brainstem": 69.26
        }
...
if __name__ == "__main__":
    ...
    pipeline = AutoFetalInference(input_dir=args.input, output_dir=args.output, weights_dir=args.weights)
